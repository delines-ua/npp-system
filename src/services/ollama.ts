...
- Іспит: 0.5 год × кількість курсантів
- Диф. залік: 0.33 год × кількість курсантів
- Керівництво дипломною роботою бакалавра: 30 год на курсанта (навчальне навантаження)
- Керівництво дипломною роботою магістра: 60 год на курсанта (навчальне навантаження)
- Керівництво ад'юнктом/докторантом: 50 год/рік (наукове навантаження)
- Ці норми типові за Табл.3 і НАЛАШТОВУЮТЬСЯ на сторінці «Налаштування» → «Керівництво дипломниками» — якщо користувач питає про фактичну норму на кафедрі, уточни що там може бути інше значення
